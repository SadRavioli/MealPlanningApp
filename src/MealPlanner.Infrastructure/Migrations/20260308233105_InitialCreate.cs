    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "Meat", "Chicken Breast" },
                    { 2, "Meat", "Ground Beef" },
                    { 3, "Fish", "Salmon Fillet" },
                    { 4, "Dairy", "Eggs" },
                    { 10, "Grains", "Pasta" },
                    { 11, "Grains", "Rice" },
                    { 12, "Grains", "Bread" },
                    ...
                    { 20, "Vegetables", "Onion" },
                    { 21, "Vegetables", "Garlic" },
                    { 22, "Vegetables", "Tomatoes" },
                    { 23, "Vegetables", "Bell Pepper" },
                    { 24, "Vegetables", "Carrots" },
                    { 25, "Vegetables", "Broccoli" },
                    { 30, "Dairy", "Milk" },
                    { 31, "Dairy", "Cheese" },
                    { 32, "Dairy", "Butter" },
                    { 33, "Dairy", "Cream" },
